...
var invoiceUrl = basicInvoice.Url;
var status = basicInvoice.Status;
...
```java
Invoice getInvoice = bitpay.GetInvoice(basicInvoice.Id).Result;
```
...
```java
Invoice updateInvoice = bitpay.UpdateInvoice(invoice.Id, "sanbox@bitpay.com", "", "").Result;
```
